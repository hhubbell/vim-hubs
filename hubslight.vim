...
" --- WORKSPACE ----------------
exe "hi Cursor          ".s:CTX_FG."=".s:WHITE."        ".s:CTX_BG."=".s:BLACK
exe "hi LineNr          ".s:CTX_FG."=".s:GRAY."         ".s:CTX_BG."=".s:WHITE
...
exe "hi StatusLine      ".s:CTX_FG."=".s:BACKGROUND."   ".s:CTX_BG."=".s:LIGHT_GRAY."   ".s:CTX_DEC."=bold"
exe "hi StatusLineNC    ".s:CTX_FG."=".s:LIGHT_GRAY."   ".s:CTX_BG."=".s:GRAY
exe "hi VertSplit       ".s:CTX_FG."=".s:LIGHT_GRAY."   ".s:CTX_BG."=".s:GRAY
exe "hi TabLine         ".s:CTX_FG."=".s:WHITE."        ".s:CTX_BG."=".s:GRAY."         ".s:CTX_DEC."=none"
exe "hi TabLineFill     ".s:CTX_FG."=".s:LIGHT_GRAY
...
exe "hi Search          ".s:CTX_FG."=".s:BACKGROUND."   ".s:CTX_BG."=".s:YELLOW
...
exe "hi Identifier      ".s:CTX_FG."=".s:BLACK
